...
// MOVIDO AFUERA: Esto evita re-renderizados innecesarios
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <View style={styles.reqList}>
              ...
              <RequirementItem text="No debe tener más de dos caracteres repetidos" isMet={reqNoSeq} />
            </View>
...
const styles = StyleSheet.create({
  ...
  scroll: { flexGrow: 1, paddingHorizontal: 30, paddingTop: '15%', alignItems: 'center' },
  title: { fontSize: 45, fontWeight: 'bold', color: COLORS.primary, textAlign: 'center', marginBottom: 40 },
  form: { width: '100%' },
  ...
  footer: { width: '100%', alignItems: 'center', marginTop: 10, marginBottom: 30 },
