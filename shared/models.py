...
class medicos(Base):
    ...
    id_medico = Column(Integer, ForeignKey("r4l.datos_personales_medico.id_medico"), primary_key = True, comment = "IDENTIFICADOR ÚNICO DEL MÉDICO (FK)")
    id_rol = Column(Integer, ForeignKey("r4l.roles_usuarios.id_rol"), nullable = False, comment = "IDENTIFICADOR DEL ROL (FK)")
    id_especialidad = Column(Integer, ForeignKey("r4l.especialidades_medicas.id_especialidad"), nullable = False, comment = "IDENTIFICADOR DE LA ESPECIALIDAD (FK)")
    ...
    codigo = Column(String(20), nullable = False, unique = True, comment = "CÓDIGO INTERNO DEL MÉDICO")
    cedula_profesional = Column(String(30), nullable = False, unique = True, comment = "CÉDULA PROFESIONAL")
    email = Column(String(255), nullable = False, unique = True, comment = "CORREO ELECTRÓNICO")
    rfc = Column(String(13), nullable = False, unique = True, comment = "RFC")
...
class pacientes(Base):
    ...
    id_sexo = Column(Integer, ForeignKey("r4l.sexos.id_sexo"), nullable = False, comment = "IDENTIFICADOR DEL SEXO (FK)")
    id_estatus_usuario = Column(Integer, ForeignKey("r4l.estatus_usuarios.id_estatus_usuario"), nullable = False, comment = "IDENTIFICADOR DEL ESTATUS (FK)")
    id_tipo_diabetes = Column(Integer, ForeignKey("r4l.tipos_diabetes.id_tipo_diabetes"), nullable = True, comment = "IDENTIFICADOR DEL TIPO DE DIABETES (FK)")
    codigo = Column(String(20), nullable = False, unique = True, comment = "CÓDIGO INTERNO DEL PACIENTE")
